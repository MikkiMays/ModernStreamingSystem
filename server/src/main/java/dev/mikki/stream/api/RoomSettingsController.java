 ...
 *
 * Отдельно от настроек интеграций рядом: те живут в своей панели и отвечают на вопрос «кому
 * можно включать музыку», а эти — на вопрос «что это за встреча и кого в неё пускать». Одно
 * поле в двух ручках оказалось бы двумя источниками правды.
 */
@RestController
