...
# Видео — её строка.
# Сериал и его сезон: у Rutube и ivi это числа. Общая форма здесь только
...
class Cinema:
    ...
    def __init__(
        ...
        *,
        ...
        # Площадки с любыми хостами («По ссылке») без секрета не регистрируются вовсе (M14).
            ...
            "providers": [
                {
                    ...
                    # Входить пока не во что: ни одной площадке кинозала аккаунт не нужен, поэтому
                    # входов у комнаты нет (сам сейф входов, `accounts.Vault`, уже есть — для Яндекс Музыки).
                    "connected": False,
                    "features": {
