 ...
 * всё время. Discord решает это иначе — периодическим кадром, а не живым потоком, и его
 * можно выключить. Здесь так же.
 *
 * ЧТО ВМЕСТО. Показывающий раз в несколько секунд рисует свой экран в канвас 256×144,
...
export const PREVIEW_INTERVAL = 4000;
/**
